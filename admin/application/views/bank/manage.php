...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h3 class="m-0 text-dark">Bank <small>/ Manage</small></h3>
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="<?= $addlink ?>" class="btn bg-primary float-right">Tambah Bank</a>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php $no = 1;
                                $path = base_url().'assets/bank/';
                                foreach ($query->result() as $row) {
                                    $editLink = base_url() . "bank/create/" . $row->id;
                                    $deleteLink = base_url(). "modal/popup/delete/" . $row->id . "/bank";
                                    $status = $row->status;
