<?php
$addlink = base_url() . "contact/create";
?>
...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h3 class="m-0 text-dark">Contact <small>/ Manage</small></h3>
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="<?= $addlink ?>" class="btn bg-primary float-right">Tambah Contact</a>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                foreach ($query->result() as $row) {
                                    $editLink = base_url() . "contact/create/" . $row->contact_id;
                                    $deleteLink = base_url(). "modal/popup/delete/" . $row->contact_id . "/contact";
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?= word_limiter($row->contact_msg, 8) ?>
                                        </td>
                                        <td>
