<?php
$backlink = base_url() . "kurir/manage";
?>
...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h3 class="m-0 text-dark">Kurir <small>/ <?= $headline ?></small></h3>
            ...
            <div class="col-md-12">
                ...
                <div class="card card-info">
                    <div class="card-header">
                        <h3 class="card-title">Kurir Details</h3>
                        <a href="<?= $backlink ?>" class="btn bg-warning float-right">Back</a>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <?php
                    $form_location = base_url() . "kurir/create/" . $update_id;
                    ?>
                    <form class="form-horizontal" method="post" action="<?= $form_location ?>">
                        
                        <div class="card-body">
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">Kurir Name</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" placeholder="Kurir Name" id="name" name="name" value="<?= $name ?>" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" placeholder="Value" id="value" name="value" value="<?= $value ?>" required>
                                    <div class="form-control-feedback" style="color: #f4516c;"><?php echo form_error('value'); ?></div>
                                </div>
                            </div>
                            <div class="form-group row">
