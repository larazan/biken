...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h3 class="m-0 text-dark">Kurir <small>/ Manage</small></h3>
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="<?= $addlink ?>" class="btn bg-primary float-right">Tambah Kurir</a>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                foreach ($query->result() as $row) {
                                    $editLink = base_url() . "kurir/create/" . $row->kurir_id;
                                    $deleteLink = base_url(). "modal/popup/delete/" . $row->kurir_id . "/kurir";
                                    $status = $row->status;
