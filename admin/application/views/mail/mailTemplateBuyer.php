                                                                    ...
                                                                    <div class="movableContent" style="border: 0px; padding-top: 0px; position: relative;">
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td style="background: #1dd3bd; color: #fff; *border: 1px solid #2bb2bb;">
                                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td width="20" valign="top" class="spechide"></td>
                                                                                                                ...
                                                                                                                <td>
                                                                                                                    <div class='contentEditableContainer contentTextEditable'>
                                                                                                                        <div class='contentEditable' style='text-align: left; font-size: 2em; font-weight: bold;'>
                                                                                                                            <h5>Terima kasih atas orderannya! <br><span style="color: #000; font-size: 1.1em;">Silahkan selesaikan transaksi anda.</span></h5>
                                                                                                                ...
                                                                                                                <td>
                                                                                                                    <div class='contentEditableContainer contentTextEditable'>
                                                                                                                        <div class='contentEditable' style='text-align: left;'>
                                                                                                                            <p>Hai, <span style="font-weight: bolder;"><?=$name?></span></p>
                                                                                                                        </div>
                                                                                                                        <div class='contentEditable' style='text-align: left;'>
                                                                                                                            <p>Selesaikan Pembayaran barang yang anda pesan.</p>
                                                                                                                        </div>
                                                                                                                        <div class='contentEditable' style='text-align: left;'>
                                                                                                                            <br>
                                                                                                                        </div>
                                                                    ...
                                                                    <div class="movableContent" style="border: 0px; padding-top: 0px; position: relative;">
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td style="background: #17a2b8; color: #ffffff; border: 1px solid #EEEEEE;">
                                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td>
