...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h3 class="m-0 text-dark">Size <small>/ Manage</small></h3>
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="<?= $addlink ?>" class="btn bg-primary float-right">Tambah Size</a>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                foreach ($query->result() as $row) {
                                    $editLink = base_url() . "size/create/" . $row->size_id;
                                    $deleteLink = base_url(). "modal/popup/delete/" . $row->size_id . "/size";
