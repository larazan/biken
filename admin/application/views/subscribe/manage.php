...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h3 class="m-0 text-dark">Subscribe <small>/ Manage</small></h3>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                foreach ($query->result() as $row) {
                                    $editLink = base_url() . "subscribe/create/" . $row->id;
                                    $deleteLink = base_url(). "modal/popup/delete/" . $row->id . "/subscribe";
                                    $status = $row->status;
