        ...
        function n(a, t) {
            ...
            (n.onload = function (a) {
                ...
                image.onload = function () {
                    ...
                    if (height > he || width > wi) {
                        alert(`Height and Width must not exceed ${he}px.`);
                        return false;
                    }
            ...
            $.each(a, function (a, i) {
                $.each(r, function (s, d) {
                    if (void 0 !== $(e + " #base64_" + a).val() && d === i.type)
                        if (parseInt($(e + " #base64_" + a).val().length) > 0) for (var r = 0, o = t + 1; o < $(e + ' input[name*="base"]').length; o++) r || 0 !== parseInt($(e + " #base64_" + o).val().length) || (n(i, o), (t = o), r++);
                        else n(i, a);
                });
            });
        }
    ...
    return {
        init: function (l) {
            Modernizr.draganddrop
                ? (void 0 !== l.max && (a = parseInt(l.max)),
                    void 0 !== l.textNew && (t = l.textNew),
                    void 0 !== l.textTitle && (n = l.textTitle),
                    void 0 !== l.textTitle && (n = l.textTitle),
                    void 0 !== l.mimes && (r = l.mimes),
                    void 0 !== l.start && (o = l.start),
                    (function (l) {
                        e = l.target;
                        var c,
                            u,
                        ...
                        if (f.length > 0)
                            for (f.html(""); o < a; o++)
                                f.append(
                                    ((c = o),
                                        (u = r.join(",")),
                                        '<div class="box-drag column" draggable="true"><input type="hidden" name="base[]" id="base64_' +
                                        c +
                                        '" data-id="' +
                                        c +
