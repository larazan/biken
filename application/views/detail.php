            ...
            <div class="row">
                ...
                <div class="col-md-6 product-detail-title">
                    ...
                    <form action="<?= base_url() ?>Basket/add_to_basket" method="post">
                        <input type="hidden" name="item_url" value="Asus-Tuf-Gaming-FX505DY-R5698T-Amd-Ryzen-5-3550H-8GB-1TB-RADEON-RX560X">
                        <input type="hidden" name="item_colour" value="1">
                        <input type="hidden" name="item_size" value="1">
                        <div class="add-to-cart">
                            <label for="">Qty</label>
                            <div class="col-md-2">
                                <input type="number" name="item_qty" id="" class="form-control" value="1">
                            </div>
                            <div class="add-to-cart">
                                <button type="submit" class="add-to-cart-btn" name="submit" value="Submit">tambah keranjang</button>
                            </div>
                        </div>
                    </form>
