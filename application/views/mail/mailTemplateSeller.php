                                                                    ...
                                                                    <div class="movableContent" style="border: 0px; padding-top: 0px; position: relative;">
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                ...
                                                                                <tr class="highlight">
                                                                                    <td style="background: #17706e; color: #fff; border: 1px solid #2bb2bb;">
                                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td class="specbundle">
                                                                                                        <table width="100%" cellpadding="0" cellspacing="0" align="center">
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <td width="5%" style="font-weight: bold; color: #212121;"></td>
                                                                                                                <td>
                                                                                                                    <div class='contentEditableContainer contentTextEditable'>
                                                                                                                        <div class='contentEditable' style='color: #fff; text-align: center; font-size: 2em; font-weight: bold;'>
                                                                                                                            <p><?= $shop_name ?></p>
                                                                                                                        </div>
                                                                                                                    </div>
                                                                                                                </td>
                                                                    ...
                                                                    <div class="movableContent" style="border: 0px; padding-top: 0px; position: relative;">
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td style="background: #b6eb7a; color: #fff; *border: 1px solid #2bb2bb;">
                                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td width="20" valign="top" class="spechide"></td>
                                                                                                                ...
                                                                                                                <td>
                                                                                                                    <div class='contentEditableContainer contentTextEditable'>
                                                                                                                        <div class='contentEditable' style='text-align: left; font-size: 2em; font-weight: bold;'>
                                                                                                                            <h5>There is new order! <br><span style="color: #000; font-size: 1.1em;">Now Please check on your dashboard.</span></h5>
                                                                                                                ...
                                                                                                                <td>
                                                                                                                    <div class='contentEditableContainer contentTextEditable'>
                                                                                                                        <div class='contentEditable' style='text-align: left;'>
                                                                                                                            <p>Dear, <span style="font-weight: bolder;">Admin</span></p>
                                                                                                                        </div>
                                                                                                                        <div class='contentEditable' style='text-align: left;'>
                                                                                                                            ...
                                                                                                                            <table width="100%" cellpadding="0" cellspacing="0">
                                                                                                                                <tbody>
                                                                                                                                    <tr style="line-height: 30px;">
                                                                                                                                        <td class="text-left"><span style="font-weight: bolder;">No Order:</span> <?= $no_order ?></td>
                                                                                                                                        <td class="text-right"><span style="font-weight: bolder;">Dikirim ke</span></td>
                                                                                                                                        
                                                                                                                                    </tr>
                                                                                                                                    <tr style="line-height: 30px;">
                                                                                                                                        <td class="text-left"><span style="font-weight: bolder;">Payment Method:</span> Bank</td>
                                                                                                                                        <td class="text-right"><?=App::getShipping($shipping_id)->firstname?></td>
                                                                                                                                        
                                                                                                                                    </tr>
                                                                                                                                    <tr>
                                                                                                                                        <td class="text-left"><?= tgl_indo('Y-m-d')?></td>
                                                                                                                                        <td class="text-right"><?=App::getShipping($shipping_id)->address?></td>
                                                                                                                                    </tr>
                                                                                                                                </tbody>
                                                                                                                            </table>
                                                                                                                        </div>
                                                                                                                        <div class='contentEditable' style='text-align: left; margin-top: 20px;'>
                                                                                                                            ...
                                                                                                                            <table width="100%" cellpadding="0" cellspacing="0">
                                                                                                                                ...
                                                                                                                                <tbody>
                                                                                                                                    ...
                                                                                                                                    <?php } ?>
                                                                                                                                    <!-- <tr class="highlight">
                                                                                                                                        <td><img src="https://picsum.photos/70" /></td>
                                                                                                                                        <td class="text-left">BS-400</td>
                                                                                                                                        <td class="text-center">1</td>
                                                                                                                                        <td class="text-right">$60.00</td>
                                                                                                                                    </tr>
                                                                                                                                    <tr class="highlight">
                                                                                                                                        <td><img src="https://picsum.photos/70" /></td>
                                                                                                                                        <td class="text-left">BS-1000</td>
                                                                                                                                        <td class="text-center">1</td>
                                                                                                                                        <td class="text-right">$600.00</td>
                                                                                                                                    </tr> -->
                                                                                                                                    <tr class="highlight2 border_upper">
                                                                                                                                        <td class="thick-line"></td>
                                                                                                                                        <td class="thick-line"></td>
                                                                                                                                        <td class="thick-line text-center"><strong>Subtotal</strong></td>
                                                                                                                                        <td class="thick-line text-right"><?= rupiah($grand_total) ?></td>
                                                                                                                                    </tr>
                                                                                                                                    <tr class=" highlight2">
                                                                                                                                        <td class="no-line"></td>
                                                                                                                                        <td class="no-line"></td>
                                                                                                    ...
                                                                                                    <td>
                                                                                                        <table width="100%" cellpadding="0" cellspacing="0" align="center">
                                                                                                            <tr>
                                                                                                                <td>
                                                                                                                    <div class='contentEditableContainer contentTextEditable'>
                                                                                                                        <div class='contentEditable' style='text-align: center;color: #212121;'>
                                                                                                                            <p><span style="font-weight: bold; font-size: 16px;color: #212121;"></span></p>
                                                                                                                        </div>
                                                                                                                    </div>
                                                                                                                </td>
                                                                                                            </tr>
                                                                    ...
                                                                    <div class="movableContent" style="border: 0px; padding-top: 0px; position: relative;">
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td style="background: #fb7813; color: #ffffff; border: 1px solid #EEEEEE;">
                                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td>
                                                                                                                ...
                                                                                                                <td>
                                                                                                                    <div class='contentEditableContainer contentTextEditable'>
                                                                                                                        <div class='contentEditable' style='text-align: center;'>
                                                                                                                            ...
                                                                                                                            <p>Jika butuh bantuan, gunakan halaman <a href="#" style="color:#00f">Hubungi kami</a></p>
                                                                                                                            <p><img src="https://www.wiklan.com/assets/images/mobile-icon.png" style="color: #fff; display: inline; height: 15px;"> <?= $phone ?> | <img src="https://www.wiklan.com/assets/images/mail-icon.png" style="display: inline; height: 15px;"><?= $email ?></p>
