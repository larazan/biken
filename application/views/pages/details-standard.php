          ...
          <div class="col-md-6 product-detail-title">
            ...
            <div class="add-to-cart">
              ...
              <div class="add-to-cart">
                <?php
                  $phone = '6285236152117';
                  $txt = 'Hi seller, saya ingin membeli barang '.strtoupper($itemData->product_title);
                  $url = 'https://wa.me/'.$phone.'?text='.$txt;
                ?>
                <button onclick="window.location.href='<?= $url; ?>'" class="add-to-cart-btn">beli sekarang</button>
              </div>
            </div>
            <div style="display: flex;">
