        ...
        <?php } ?>
                ...
                <div class="col-sm-6 col-md-4 col-md-offset-4">
                    ...
                    <div class="form-white">
                        <form role="form" action="<?=base_url()?>account/resetPasswordUser" method="post">
                            <div class="form-group">
                                <label for="email-lost">Email address</label>
                                <input type="email" class="form-control" name="login_email" id="email-lost" placeholder="Enter email" required>
                            </div>
                           
                            <button type="submit" class="btn btn-block btn-color btn-xxl" name="submit" value="Submit">Send</button>
                        </form>
                        <hr>
